...
//    $options['band_name'] = $options['band_term']->name;
    ...
    {	
        ...
        {
            echo '<div class="col-md-4"><div class="block"';
            echo '<div class="alert alert-warning"><i class="fa fa-exclamation-triangle"></i> No ' . $band_name . ' ' . $selected_instrument_name . ' arrangements found!</div>';
            echo '</div></div>';
        }
        ...
        { ?>
            ...
            <div class="col-lg-<?php echo $panel_width; ?>">
                                    ...
                                    foreach( $files as $file){
                                           ...
                                           )
                                        {
                                            ...
                                            if($selected_instrument_name == "Recordings") {
                                                ...
                                                echo '<a class="btn btn-xs ' . $dl_btn_theme . '" href="'.$file['file'].'" target="_blank"><i class="fa fa-play"></i></a>';																				
                                            ...
                                            // Not recording
                                                ...
                                                {
                                                    echo '<a class="btn btn-xs ' . $dl_btn_theme . '" href="'.$file['file'].'" target="_blank"><i class="' . $single_dl_fa . '"></i></a>';
                                                }
